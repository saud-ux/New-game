...
async function generateClues(description, forbidden = [], knownAnswer = null) {
  ...
  const answerLine = knownAnswer
    ? `الشخصية هي: "${knownAnswer}" — هذا هو ما يجب على اللاعبين تخمينه، لا تستخرجه من الوصف.`
    : `١. استخرج الاسم الصحيح للشخصية من الوصف — هذا هو ما يجب على اللاعبين تخمينه`;

  const content = knownAnswer
    ? `أنت تدير لعبة "من أنا؟". المضيف وصف الشخصية هكذا: "${description}"
${answerLine}
...
{"answer":"${knownAnswer}","clues":["التلميح1","التلميح2","التلميح3","التلميح4","التلميح5","التلميح6","التلميح7","التلميح8","التلميح9","التلميح10"]}`
    : `أنت تدير لعبة "من أنا؟". المضيف وصف الشخصية هكذا: "${description}"
